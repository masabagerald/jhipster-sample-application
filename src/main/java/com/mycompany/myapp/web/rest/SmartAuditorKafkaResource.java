...
@RestController
@RequestMapping("/api/smart-auditor-kafka")
public class SmartAuditorKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SmartAuditorKafkaResource.class);
    ...
    public SmartAuditorKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
